...
public class ResurrectButtonWidget extends TexturedButtonWidget {
    ...
    public ResurrectButtonWidget(int x, int y, int width, int height, Identifier texture, PressAction pressAction, MinecraftClient client) {
        super(x, y, width, height, 0, 0, texture, pressAction);
        this.client = client;
    }
    ...
    public void renderButton(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(ICON, iconX, iconY, 0, 0, iconWidth, iconHeight);
